...
class SettingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        aboutTextView.text = "Val (short for Valerian) utilizes cognitive behavioural therapy (CBT) to help users as much as possible! CBT is a mental exercise proven to be one of the best methods to improve daily mood and overall health. The key steps in CBT is to: identify and get to know automatic negative thoughts that are spontaneously triggered, ask whether there is concrete evidence or good reason to feel the way you do, challenge your initial thoughts by doubting your instincts, and find an alternative to view the thought or situation."
        ...
        helpTextView.text = "Val is not a replacement for a real therapist or psychologist. If you ever need to talk to someone for anonymous emotional support, please call (212) 673-3000. Free, immediately accessible, confidential, 24/7."
